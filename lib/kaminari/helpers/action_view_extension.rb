module Kaminari
  ...
  module ActionViewExtension
    ...
    def paginate(scope, options = {}, &block)
      ...
      paginator = Kaminari::Helpers::Paginator.new(self, options.reverse_merge(:current_page => scope.current_page, :per_page => scope.limit_value, :remote => false, :scope => scope))
      paginator.to_s
    end
